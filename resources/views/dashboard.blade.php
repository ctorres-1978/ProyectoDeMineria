<x-guest-elegante>
    <div class="p-6 text-gray-900" style="text-align: center;">
        ...
        <a href="{{ route('admin.create-user') }}" style="display: block; width: 100%; padding: 14px; background-color: #b07c64; color: white; border: none; border-radius: 8px; font-size: 18px; text-align: center; text-decoration: none; transition: background-color 0.3s, box-shadow 0.3s; margin-bottom: 15px; box-sizing: border-box;">
            Crear Nuevo Usuario
        </a>
